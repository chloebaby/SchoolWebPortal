...
public class Constants {
	...
	public static final String REQUEST_ACTION_CANCEL = "cancel";
	...
	public static final String REQUEST_ATTRIBUTE_COURSE = "course";
	...
	public static final String PDF_COMMAND = "command";
